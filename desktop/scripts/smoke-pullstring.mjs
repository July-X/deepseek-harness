...
// Fire the fade timer the click scheduled.
pendingTimers.forEach((fn) => fn());
if (btn.classes.has("dsh-launcher-on")) throw new Error("bulb light did not fade");
...
pendingTimers.forEach((fn) => fn());
if (btn.classes.has("dsh-launcher-err")) throw new Error("error flash did not fade");
